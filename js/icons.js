...
(function () {
  ...
  var D = {
    ...
    cofre: '<path d="M3.5 9.5h17v9a2 2 0 0 1-2 2h-13a2 2 0 0 1-2-2z"/><path d="M3.5 9.5 6 4.2a1.6 1.6 0 0 1 1.45-.9h9.1a1.6 1.6 0 0 1 1.45.9l2.5 5.3"/><path d="M12 3.3v6.2"/><path d="M9.6 13.6h4.8"/>',
    pincel: '<rect x="9.4" y="3.4" width="11.2" height="5" rx="1.6"/><path d="M9.4 5.9H6.3a1.7 1.7 0 0 0-1.7 1.7v2.3a1.7 1.7 0 0 0 1.7 1.7h5.7"/><rect x="9.6" y="11.6" width="4.8" height="3.6" rx="1.3"/><path d="M12 15.2v5.4"/>',
    ...
    dxf: '<path d="M4.5 5.5h9l4.5 4.5v8.5h-13.5z"/><path d="M13.5 5.5V10h4.5"/><path d="M6.8 13.2 9.4 17M9.4 13.2 6.8 17"/><path d="M11.6 13.2v3.8h1.4a1.9 1.9 0 0 0 1.9-1.9 1.9 1.9 0 0 0-1.9-1.9z"/>',
    trim: '<path d="M4.5 4.5 19.5 19.5"/><path d="M19.5 4.5 12 12"/><circle cx="5.6" cy="18.4" r="2.1"/><circle cx="18.4" cy="18.4" r="2.1"/>',
    girar: '<path d="M20.3 12a8.3 8.3 0 1 1-2.43-5.87"/><path d="M20.4 3.6v4.9h-4.9"/>',
